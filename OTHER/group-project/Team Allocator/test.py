...
# GROUPING STUDENTS ACCORDING TO LOCATION
def dbn_campus_students(student_list):
    ...
    '''
    # # opening student list and reading
    # f = open("student_list.txt", "r")
    # data = f.readlines()
    ...
    for i in student_list:
        if "Durban" in i:
            dbn_students.append(i)  # if found, add to dbn students list
...
if __name__ == '__main__':
    ...
    '''
    # calling function to create student list as text file
    # student_list()
